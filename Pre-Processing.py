...
# for feature selection visit:
# https://towardsdatascience.com/feature-selection-techniques-in-machine-learning-with-python-f24e7da3f36e
data = pd.read_csv('E:/Network Data/appclass.csv')

data.drop(columns=['Flow.ID', 'Source.IP', 'Destination.IP', 'Protocol', 'Timestamp', 'Fwd.Packet.Length.Max',
                   'Fwd.Packet.Length.Min',
                   'Bwd.Packet.Length.Max', 'Bwd.Packet.Length.Min', 'Flow.IAT.Max', 'Flow.IAT.Min', 'Fwd.IAT.Max',
                   'Fwd.IAT.Min', 'Bwd.IAT.Max', 'Bwd.IAT.Min',
                   'Fwd.Header.Length.1', 'Label', 'L7Protocol', 'Bwd.Avg.Bulk.Rate', 'Bwd.Avg.Packets.Bulk',
                   'Bwd.Avg.Bytes.Bulk', 'CWE.Flag.Count', 'Fwd.Avg.Bytes.Bulk',
                   'Fwd.Avg.Bulk.Rate', 'Bwd.Avg.Bytes.Bulk', 'Bwd.Avg.Packets.Bulk', 'Fwd.Avg.Bulk.Rate',
                   'Bwd.Avg.Bulk.Rate', 'Fwd.URG.Flags', 'Bwd.PSH.Flags', 'Bwd.URG.Flags',
...
data.drop(columns=['Flow.Duration', 'Total.Fwd.Packets', 'Total.Backward.Packets',
    ...
    , 'Bwd.Packet.Length.Mean', 'Bwd.Packet.Length.Std', 'Flow.Bytes.s', 'Flow.Packets.s', 'Flow.IAT.Mean',
                   'Flow.IAT.Std'
    , 'Fwd.IAT.Total', 'Fwd.IAT.Mean', 'Fwd.IAT.Std', 'Bwd.IAT.Total', 'Bwd.IAT.Mean', 'Bwd.IAT.Std',
                   'Fwd.Header.Length'
    , 'Bwd.Header.Length', 'Fwd.Packets.s', 'Bwd.Packets.s', 'Packet.Length.Variance', 'SYN.Flag.Count',
                   'PSH.Flag.Count',
                   'ACK.Flag.Count', 'URG.Flag.Count', 'Down.Up.Ratio', 'Average.Packet.Size', 'Avg.Fwd.Segment.Size',
...
data['ProtocolName'] = data['ProtocolName'].map(map_ProtocolName)
# stacked = data[['ProtocolName']].stack()
# data[['ProtocolName']] = pd.Series(stacked.factorize()[0], index=stacked.index).unstack()
...
# on unseen data
results = knn.predict(dataunseen)
